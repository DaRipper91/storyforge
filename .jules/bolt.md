...
## 2024-05-20 - Optimizing Konva Node Recreation
**Learning:** Destroying and recreating Konva nodes on high-frequency events (e.g., `mousemove` mapping to cursor movements or rendering) creates Garbage Collection pressure and micro-stutters.
**Action:** Optimize by instantiating graphics objects once and mutating their properties during the event loop or render function.
