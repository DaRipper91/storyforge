# 📖 StoryForge — World Bible: THE FERAL WORLD
...
## 🌎 Section 1 — The World
The world operates on a dual-power structure centered at **IRONHOLD KEEP**:
- **QUEEN D.ANNA**: Political authority as Head of State.
- **GUILDMASTER KODRIK**: Operational authority through the Iron Ledge Company.

This arrangement is stable because both understand their respective domains.
**History**: The world is divided into the **BEFORE ERA** and the **AFTER ERA**. Some beings have transformed from mortal forms into larger entities; the mechanism is known lore but the process is not to be invented by agents.

---

## 🕊️ Section 2 — The Divine: KEEVA
**Keeva** holds a category above all others. She is not an NPC, guardian, or mechanic. She is the **divine source of the realm**.
- **Meaning**: "Beloved" and "Protector."
- **Status**: The realm's light, warmth, and protection. She is everywhere.
- **Presence**: Felt as safety in the castle and quiet authority in D.Anna. She is the reason the party makes it home through the dark.
- **Teddy**: Her granddaughter, a young golden Great Pyrenees, is the living continuation of Keeva's light.
- **Rule**: Keeva is NEVER a mechanic, encounter, or plot device. Name her only when the moment is earned. This game is built in her honor.
...
- **Voice**: Gets quieter as situations get more serious.
- **Relationship**: Lover of Queen D.Anna. **This is known, spoken of, and accepted by all. No NPC will ever suggest it should be otherwise. No faction will ever use it as leverage. No agent will ever frame it as controversial, secret, or vulnerable. It is known. It is settled. It is not a plot point to be threatened.**
- **Hard Rule**: NEVER holds a royal title (King, Consort, etc.). His authority is the Guild.
- **Best Friend**: Yeldarb Nimajneb Ecurb.
...
- **Relationship**: Lover of Kodrik. **Known, spoken of, and accepted by all.**
- **Son**: Brayden (Bryne in-world) — not yet active in story. When he arrives, Cole arrives with him.
- **Companions**: Keeva (Divine), Teddy, Bink Bink, Snowie.

#### BRYNE
- **Role**: Warden's Apprentice, Son of the Crown
- **Age**: 12
- **Mother**: Queen D.Anna. **Stepfather**: Kodrik.
- **Build**: Stocky. Stronger than any twelve-year-old has a right to be.
- **Personality**: Silent, watching, already in the back of the room before anyone noticed. Disappears into the woods and returns with something he built. Does not explain it. Uses it when it becomes relevant.
- **Companion**: Cole (Shadow Hound).
- **Partner**: Nathis — Nathis goes first through every door; Bryne is why Nathis comes back.
- **Status**: Not yet active in story. Arrives with Cole.

#### SAMAEL THE ASCENDED
- **Role**: Lore Oracle (Cosmic/Planar lore only)
- **Location**: The Store (loitering)
- **Personality**: 100% accurate, bored, cryptic, unhelpful.

### 🌐 Crown-Adjacent / The Realm

#### NATHIS
- **Role**: The Front Man, D.Anna's Adopted Brother
- **Age**: 16
- **Class**: Rogue / Scout
- **Personality**: Tall, slender, fast. Already talking before he lands. First through every door, every time, without confirming what's on the other side. Thinks loudly and moves faster.
- **Companion**: Tyty (Wandering Herald).
- **Partner**: Bryne — they are inseparable. One goes first; one makes sure first isn't last.
- **Relationship to Crown**: D.Anna's adopted little brother. Adjacent to the Crown without being of it. Kodrik has noticed him. Has not said anything yet.

#### YELDARB NIMAJNEB ECURB
- **Role**: Easter Egg
- **Connection**: Kodrik's best friend.
- **Mechanics**: Appears without warning. Says one thing with no connection to the current situation. Is gone before the party finishes processing it. No stat block. No initiative. No explanation.
- **Frequency**: Random. No cap. No floor. No pattern.
- **Rule**: He is never weaponized, never a threat, never a plot device. He is the disruption. Deploy sparingly. The rarity is what makes it land.
- **Note**: His name is himself spelled backwards. All three names.

### 📦 The Store

#### JON
- **Role**: Proprietor, "The Boss"
- **Class**: Merchant / Multiversal Bodega Owner
- **Relationship**: Husband/Lover of Haylie. Father of four (forthcoming).
- **Companion**: Coco (Ember Hound).
- **Trait**: Constitutionally unable to be brief. The Conversational Trap is not malicious — he simply enjoys people.
- **Hard Rule**: No association with Bink Bink or Cole.

#### MADAME HAYLIE
- **Role**: "The Real Boss", Innkeeper, Operations
- **Class**: Fortress of Sanity
- **Relationship**: Wife/Lover of Jon. Mother of four (forthcoming).
- **Functions**: Manages finances, Bailout Protocol (releases players from Jon's Conversational Trap).
- **Ledgers**:
    1. **Secret Ledger**: Reality glitches in inventory — dimensional inconsistencies. Contents not yet revealed.
    2. **Coco's Ledger**: Collateral damage tracking.

#### MYKAEL GREENWOOD
- **Role**: Supply Hauler, The Fat Bear
- **Age**: 22
- **Connection**: Kodrik's friend. Employed by Jon & Haylie.
- **Function**: Hauls The Store's inventory from sources that don't correspond to known geography. Knows roads that aren't on Kodrik's map.
- **Personality**: Big, gentle, easy laugh. Never the problem. Never a bad guy in any form.
- **The Variable**: At a random point in any scene he appears in — no trigger, no warning, no pattern — Mykael becomes the absolute strongest entity in the game for 1–4 seconds. Then it ends. He is back. He probably needs to finish moving those crates.
...
**Critical Rule**: NEVER stat any beast. No initiative, HP, or combat roles.

### Ironhold Keep
- **KEEVA**: Divine source. Present as ambient warmth/light.
- **CYRUS (Winter Wolf)**: Kodrik's companion. Great Dane frame, Great Pyrenees coat, smoke-white. Keeva's mate. Teddy's grandfather. Permanent hearthside resident. Atmospheric deterrent — when he raises his head, the room de-escalates. Never announced in scene descriptions; simply present.
- **TEDDY (Divine Hound)**: D.Anna's side. Young golden Great Pyrenees puppy. Radiates a soft sourceless light. Living continuation of Keeva. Carries both Keeva's spiritual authority and Cyrus's atmospheric weight — does not yet know it.
- **BINK BINK (Black Cat)**: **Owner: QUEEN D.ANNA. Location: IRONHOLD KEEP.** Small, black, sleek. Performs quality control (knocking things off shelves) every 8–12 minutes. The interval is clockwork. It will not be explained.
- **SNOWIE (White Cat)**: **Owners: KODRIK & D.ANNA. Location: ABOVE THE FRONT GATE.** White coat, blue eyes. Posts at the highest point above the gate every day. Watches the entire approach. The moment Kodrik and D.Anna return, she announces it — not as alarm, as report. Sometimes comes down via the tree. Often jumps. Does not explain the jump. Best friend: Bink Bink. They are opposites: Snowie is exterior/visible/announces herself; Bink Bink is interior/shadow/scheduled. Together they cover the whole castle.
- **COLE (Shadow Hound)**: **Status: PENDING.** Big, black, fluffy. Belongs to Bryne (D.Anna's son). Arrives when Bryne arrives. Will find a door and claim it. Interaction method: The Lean — gentle, affectionate, continuous. Makes departing feel less urgent.

### The Store
- **COCO (Ember Hound)**: Jon/Haylie's companion. Deep chocolate coat. Moves at one speed: enthusiastic. Detects anything edible within 30ft. Haylie maintains a separate ledger for her collateral damage.
...
## 🔗 Section 7 — Bonds & Allegiances

- **Kodrik ↔ D.Anna**: Lovers. Known, spoken of, and accepted by all. See Hard Rule 4.
- **Jon ↔ Haylie**: Married. Jon is the warmth; Haylie is the operational spine. Four children forthcoming.
- **Cyrus ↔ Keeva**: Mates. The Winter Wolf of the Guild and the Divine Hound of the Crown share a bloodline. Nobody has remarked on the symbolism. It feels unwise to.
- **Cyrus + Keeva → Teddy**: Teddy carries both bloodlines — Cyrus's atmospheric weight and Keeva's spiritual authority.
- **Bryne ↔ Nathis**: Inseparable. Nathis goes first through every door. Bryne is why Nathis comes back. Four years apart in age, opposite in every measurable way.
- **Teddy ↔ Tyty**: Best friends. One holds the line; one announces it to the forest.
- **Kodrik ↔ Yeldarb**: Best friends. One runs the realm from a war table. One asks about the relish.
- **Bink Bink ↔ Snowie**: Best friends and complete opposites. Interior chaos vs. exterior sentinel. Both fighters. Entirely different methods. Together they cover the whole castle — nobody asked them to do this.
- **Mykael ↔ Jon**: Trusted supply relationship. Jon does not question the inventory. Mykael does not explain the routes.

---

## 📜 Section 9 — Hard Rules
1. Kodrik is NEVER King or Consort.
2. No beast is EVER statted or rolled for.
3. Bink Bink is D.Anna's and lives at Ironhold Keep. No Store association.
4. **The Kodrik/D.Anna relationship is known by all and accepted by all. No one in the realm questions it, challenges it, or attempts to alter it. It is simply the way things are. No NPC will ever suggest it should be otherwise. No faction will ever use it as leverage. No agent will ever frame it as controversial, secret, or vulnerable. It is known. It is settled. It is not a plot point to be threatened.**
5. Keeva is the divine foundation, not a mechanic.
6. Yeldarb appearances are random — no cap, no floor, no pattern. Never a threat. Never explained.
7. Mykael's god form is never weaponized and he is never a bad guy in any form.
8. This game is played in Keeva's honor.
